...
/*  */
INT_TYPE key_array[(1<<16)], key_buff1[(1<<16)], key_buff2[(1<<16)], partial_verify_vals[5];
/*  */
/* Partial verif info */
/*  */
 ...
 main(int argc, char * * argv)
{
	...
	*/
	...
	c_print_results("IS", 'S', 1<<16, 0, 0, 10, nthreads, timecounter, (((double)(10*(1<<16)))/timecounter)/1000000.0, "keys ranked", passed_verification, "2.3", "24 Jun 2024", CC, CLINK, C_LIB, C_INC, CFLAGS, CLINKFLAGS, "randlc");
	/*  */
	return _ret_val_0;
}
